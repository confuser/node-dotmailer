...
, 'GetSurfysById': prepareRequest.bind(null, 'GET', 'surveys/{id}')
, 'GetSurfysFields': prepareRequest.bind(null, 'GET', 'surveys/{id}/fields')
, 'GetSurfysResponses': prepareRequest.bind(null, 'GET', 'surveys/{id}/responses?select={select}&skip={skip}')
, 'GetSurfysResponsesWithActivitySinceDate': prepareRequest.bind(null, 'GET', 'surveys/{id}/responses/with-activity-since/{date}?select={select}&skip={skip}')
